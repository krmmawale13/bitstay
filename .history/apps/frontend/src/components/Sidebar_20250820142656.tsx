...
export default function Sidebar({ isOpen, toggle }: SidebarProps) {
  ...
  before:bg-[radial-gradient(120%_60%_at_0%_0%,rgba(255,255,255,0.18),rgba(255,255,255,0)_60%),repeating-linear-gradient(90deg,rgba(255,255,255,0.05)_0_2px,transparent_2px_10px)]
  before:mix-blend-soft-light before:opacity-70"
    >
      {/* Logo / Project Name */}
      <div
