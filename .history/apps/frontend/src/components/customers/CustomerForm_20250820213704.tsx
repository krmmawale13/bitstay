...
// If backend returns state as relation object, handle both cases:
// - state: "Maharashtra"
  ...
  useEffect(() => {
    ...
    getCustomerById(customerId)
      .then((data: Customer | null) => {
        ...
        // state could be string or object { name }
        const stateVal =
        ...
        ? [
            {
              ...
              state: form.address0.state?.trim() || undefined, // backend maps string->relation
