...
const NAV_ITEMS: NavItem[] = [
  ...
  { name: "Customers", path: "/customers", icon: Users, required: ["customers.read"] },
  ...
  // You can later restrict this to ADMIN-only by changing required to something stricter
  { name: "Access Control", path: "/settings/access", icon: Settings, required: ["dashboard.view"] },
];
...
export default function Sidebar({ isOpen, toggle }: SidebarProps) {
  ...
  // For non-admins, either hide disallowed items or render them disabled.
  // Here, we SHOW ONLY allowed items (cleaner UX). To switch to "show but disabled",
  // change map source from `visible` to `NAV_ITEMS` and branch on `allowed`.
