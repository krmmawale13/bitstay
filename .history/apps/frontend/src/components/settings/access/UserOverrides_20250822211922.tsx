      ...
      <aside className="w-80 shrink-0 rounded-2xl border border-slate-200 dark:border-slate-800 bg-white/80 dark:bg-slate-900/70 backdrop-blur-xl p-3">
        <div className="flex items-center gap-2 mb-2">
          <input
            ...
            className="flex-1 h-10 rounded-xl border border-slate-300 dark:border-slate-700 bg-transparent px-3 focus:ring-2 focus:ring-indigo-500"
          />
          <div className="relative">
            <select
              value={roleFilter}
              onChange={(e) => setRoleFilter(e.target.value)}
              className="h-10 min-w-[140px] appearance-none rounded-xl border border-slate-300 dark:border-slate-700 bg-transparent pl-3 pr-8 text-sm focus:ring-2 focus:ring-indigo-500"
