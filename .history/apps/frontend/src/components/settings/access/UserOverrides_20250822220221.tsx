          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              {groupedPerms.map(([groupName, keys]) => {
                const visibleKeys = keys.filter(perm => shouldShow(perm));
                if (visibleKeys.length === 0) return null;

                return (
                  <PermGroup key={groupName} title={groupName}>
                    {/* Bulk row (moved inside to keep title as string) */}
                    <div className="flex items-center justify-end gap-1.5 mb-2">
                      <button
                        ...
                        onClick={() => bulkSet(visibleKeys, "grant")}
                      ...
                      <button
                        ...
                        onClick={() => bulkSet(visibleKeys, "neutral")}
                      ...
                      <button
                        ...
                        onClick={() => bulkSet(visibleKeys, "revoke")}
