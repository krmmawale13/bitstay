...
export default function Sidebar({ isOpen, toggle }: SidebarProps) {
  ...
  return (
   ...
   className="
  relative min-h-screen flex flex-col shadow-lg border-r border-gray-200 dark:border-gray-700
  bg-gradient-to-r from-teal-500 via-cyan-500 to-blue-500
  dark:from-gray-900 dark:via-gray-800 dark:to-gray-900

  before:content-[''] before:absolute before:inset-0 before:pointer-events-none
  before:bg-[linear-gradient(180deg,rgba(255,255,255,0.10)_0%,rgba(255,255,255,0.05)_22%,rgba(255,255,255,0)_55%),repeating-linear-gradient(90deg,rgba(255,255,255,0.06)_0_2px,transparent_2px_10px)]
  before:mix-blend-soft-light before:opacity-60
"
